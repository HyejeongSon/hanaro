...
export const getReactionByUserAndPost = async (userId: string, postId: number) => {
...
export const toggleReaction = async (postId: number, type: ReactionType): Promise<ReactionResult> => {
